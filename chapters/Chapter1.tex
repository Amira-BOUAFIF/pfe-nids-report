...
In this section, we present the methodologies that we use in this project, including the machine learning methodology \textbf{CRISP-DM}\cite{CRISP} and the software development methodology \textbf{UML}\cite{UML}.
\subsection{CRISP-DM}
