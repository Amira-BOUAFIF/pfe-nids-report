...
\begin{itemize}
    \item \textbf{Signature-based:} These systems analyze network traffic, often through deep packet inspection and comparesion against a signature database. When a match is found an alert is triggered. Well-known tools such as Snort \cite{Snort} and Suricata \cite{Suricata} are representative of this approach.
