...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\columnwidth, fbox]{../logos/class_distribution_per_file.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\columnwidth, fbox]{../logos/Attack_only_Distribution_log.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.97\columnwidth, fbox]{../logos/correlation_heatmap.png}
