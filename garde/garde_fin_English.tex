...
\begin{titlepage}
    ...
    \vskip0.3cm%
    \textit{By}\\
    \textsc{\large Amira BOUAFIF}\\[0.1cm] % Minor heading
    \textsc{\large Hajer JEMAA}\\[0.4cm] % Minor heading
    \vskip0.5cm%
    ...
    %\smallskip
    \includegraphics[width=0.18\columnwidth]{logos/itxtree-logo.png}\\
    %\end{center}
